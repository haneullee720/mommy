...
const NAV = [
  ...
  { href: "/partner/requests", label: "새 요청", icon: "🔔" },
  { href: "/partner/quotes", label: "보낸 견적", icon: "📤" },
  { href: "/partner/orders", label: "수주 작업", icon: "🧹" },
  { href: "/partner/settlement", label: "정산", icon: "💰" },
  { href: "/partner/reviews", label: "후기 관리", icon: "⭐" },
];
    ...
    <div className="bg-ink-50/40">
      <div className="container-page grid gap-8 py-10 md:grid-cols-[230px_1fr]">
        <aside className="md:sticky md:top-24 md:self-start">
          <div className="mb-4 hidden rounded-2xl border border-ink-200 bg-white p-4 md:block">
            <p className="text-[13px] text-ink-400">파트너</p>
            <p className="mt-0.5 truncate text-[16px] font-extrabold text-ink-900">{ctx.partner.companyName}</p>
            ...
            {ctx.partner.status !== "approved" && (
              <p className="mt-3 rounded-lg bg-amber-50 px-2.5 py-2 text-[11.5px] font-semibold text-amber-700">

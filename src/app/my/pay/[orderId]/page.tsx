...
export default async function PayPage({ params }: { params: Promise<{ orderId: string }> }) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        <h1 className="text-[24px] font-extrabold text-ink-900">안전결제</h1>
      ...
      <div className="grid gap-6 lg:grid-cols-[1fr_360px]">
        <div className="card p-6">
          <h2 className="text-[16px] font-extrabold text-ink-900">결제 수단 선택</h2>
          <div className="mt-5">
        ...
        <aside className="space-y-4 lg:sticky lg:top-24 lg:self-start">
          <div className="card p-5">
            ...
            <div className="mt-2 flex items-center gap-2">
              <p className="text-[16px] font-extrabold text-ink-900">{partner.companyName}</p>
            ...
            <div className="mt-4 flex items-baseline justify-between border-t border-ink-100 pt-4">
              ...
              <span className="tnum text-[22px] font-extrabold text-ink-900">{won(order.amount)}</span>
            </div>
          ...
          <div className="rounded-2xl border border-brand-200 bg-brand-50/60 p-5">
            <p className="text-[13.5px] font-extrabold text-brand-800">🔒 안전결제로 보호됩니다</p>

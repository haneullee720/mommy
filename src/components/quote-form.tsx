...
// 경력·시공 건수처럼 업체마다 사실이 다른 문구는 넣지 않는다.
// 기본 문구가 곧 고객에게 하는 약속이 되므로, 지키지 못할 주장을 대신 써 주지 않는다.
const TEMPLATES = [
  "안녕하세요, {company}입니다. 요청하신 조건으로 시공해 드리겠습니다. 작업 전후 사진을 보내드리고, 미흡한 부분은 무상으로 다시 봐 드립니다.",
  "요청 주신 일정에 바로 투입 가능합니다. 사용하는 약품과 장비, 투입 인원은 아래 조건에 적어 두었습니다.",
  "새시 분리 세척과 후드 내부까지 기본 포함이며, 견적 금액 외에 추가 비용은 발생하지 않습니다.",
];
